...
readData <- function(saveAs, saveRG = FALSE)
{
...
filterProbes <- function(datGr, dist=2, mafcut=0, and=TRUE, rmcrosshyb = TRUE, rmXY=TRUE)
{
...
gsaseq <- function(sig.de, universe, collection, plot.bias=F, gene.length=N, sort=T)
{
