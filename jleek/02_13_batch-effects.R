# my annotated version of Jeff Leek's script.
...
## this next bit is from his 3min or so "B" part of his batchfx section in the coursera course.
# actually it's not a very well done part
...
# now he just happens to know how "controls" are encoded h
