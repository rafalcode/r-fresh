...
mu <- 2^c(8,10,9,11,10,12) # six gene count vectors, one for each condition-group (2 conditions, 3 groups)
...
Cairo(1600, 800, "dev0_nogrp.png", bg="white")
g1 <- plotit0(d, "Gene 1") + ylim(7,13)
g2 <- plotit0(d2, "Gene 2") + ylim(7,13)
grid.arrange(g1, g2, ncol=2)
dev.off()
